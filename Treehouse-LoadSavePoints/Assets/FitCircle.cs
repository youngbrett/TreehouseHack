...
public class FitCircle : MonoBehaviour {
	...
	public GameObject center; //Object to be placed at the circle's center point;
    ...
    void Update() {
		...
		//if (center) {
		//	center.transform.position = new Vector3 (x_c, 0, y_c);
		//	center.transform.localScale = new Vector3(r*2, 0.01f, r*2);
		//}
